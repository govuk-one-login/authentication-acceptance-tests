...
public class RpStubStepDef extends BasePage {
    ...
    @When(
            "the user returns from the stub relying party with default options and is taken to the {string} page")
    ...
    @When(
            "the user returns from the stub relying party with options: {rpStubOptions} and is taken to the {string} page")
    ...
    @When(
            "the user returns from the stub relying party with option {word} and is taken to the {string} page")
