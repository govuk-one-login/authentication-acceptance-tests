...
public class ReenterYourSignInDetailsToContinuePage extends BasePage {
    UserLifecycleController userLifecycleController = UserLifecycleController.getInstance();
    ...
    public void enterDifferentIncorrectEmailAddressesNumberOfTimes(Integer numberOfTimes) {
        for (int i = 1; i <= numberOfTimes; i++) {
            enterEmailAddressAndContinue(userLifecycleController.generateNewUniqueEmailAddress());
