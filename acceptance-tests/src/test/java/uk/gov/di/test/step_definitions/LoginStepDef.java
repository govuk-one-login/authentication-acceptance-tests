...
public class LoginStepDef extends BasePage {
    ...
    public void theUserClicksTheForgottenPasswordLink() throws MalformedURLException {
        enterYourPasswordPage.clickForgottenPasswordLink();
    }

    @When("the user selects sign in")
    public void theUserSelectsSignIn() throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
        createOrSignInPage.clickSignInButton();
    }

    @And("user enters {string} email address")
    public void userEntersEmailAddress(String email) throws MalformedURLException {
    ...
    public void userEntersSameEmailAddressForReauth(String email) throws MalformedURLException {
        reenterYourSignInDetailsToContinuePage.enterEmailAddressAndContinue(
                System.getenv().get(email));
    }

    @When("user enters invalid email address")
    public void userEntersInvalidEmailAddress() throws MalformedURLException {
        enterYourEmailAddressToSignInPage.enterEmailAddressAndContinue(INVALID_EMAIL);
    }

    @When("the user enters the correct password")
    @When("the user enters their password")
    public void theUserEntersTheirPassword() throws MalformedURLException {
    ...
    public void theUserEntersTheirNewPassword() throws MalformedURLException {
    ...
    public void theUserClicksTheGetANewCodeLink() throws MalformedURLException {
    ...
    public void theUserIsTakenToTheIdentityProviderWelshLoginPage() throws MalformedURLException {
        assertEquals(
    ...
    public void theUserIsTakenToTheWelshEnterYourEmailPage() throws MalformedURLException {
        assertEquals(
    ...
    public void theUserIsPromptedForTheirPasswordInWelsh() throws MalformedURLException {
        assertEquals("Rhowch eich cyfrinair - GOV.UK One Login", Driver.get().getTitle());
    }

    @When("user enters {string} email address in Welsh")
    public void userEntersEmailAddressInWelsh(String email) throws MalformedURLException {
        enterYourEmailAddressToSignInPage.enterEmailAddressAndContinueWelsh(
                System.getenv().get(email));
    }

    @When("the user enters valid new password and correctly retypes it")
    public void theUserEntersValidNewPasswordAndCorrectlyRetypesIt() throws MalformedURLException {
    ...
    public void theUserResetsTheirPasswordToAnInvalidOne() throws MalformedURLException {
        resetYourPasswordPage.enterPasswordResetDetailsAndContinue(
    ...
    public void confirmationThatTheUserWillGetSecurityCodesViaIsDisplayed(String authenticationType)
            throws MalformedURLException {
    ...
    public void theNewUserAddTheSecretKeyOnTheScreenToTheirAuthApp() throws MalformedURLException {
    ...
    public void theNewUserEntersTheSecurityCodeFromTheAuthApp() throws MalformedURLException {
    ...
    public void theUserSwitchesLanguage(String language) throws MalformedURLException {
    ...
    public void theUserAgreesToTheUpdatedTermsAndConditions() throws MalformedURLException {
    ...
    public void theUserEntersIncorrectPassword() throws MalformedURLException {
    ...
    public void theUserEntersAnIncorrectPhoneSecurityCode() throws MalformedURLException {
    ...
    public void theUserEntersAnIncorrectAuthAppSecurityCode() throws MalformedURLException {
        enterThe6DigitSecurityCodeShownInYourAuthenticatorAppPage
    ...
    public void theSmsUserCanChangeHowTheyGetSecurityCodes() throws MalformedURLException {
        crossPageFlows.smsUserChangeHowGetSecurityCodesToAuthApp();
    }

    @Then("the auth app user changes how they get security codes")
    public void theAuthAppUserCanChangeHowTheyGetSecurityCodes() throws MalformedURLException {
        crossPageFlows.authAppUserChangeHowGetSecurityCodesToSms();
    }

    @When("the sms user changes their password during reauthentication")
    public void theUserChangesTheirPasswordDuringReauth() throws MalformedURLException {
