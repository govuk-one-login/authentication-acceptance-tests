@lockouts @lockout_create_account
Feature: Create account

  # ENTER INCORRECT EMAIL OTP TOO MANY TIMES DURING CREATE ACCOUNT - REG
  Scenario: A user is not blocked when they enter an incorrect email OTP code more than 5 times during create account.
