...
Feature: User forced to reset their One Login password
  ...
  Scenario: User has to reset their password intervention (happy path) (for sms user)
...
#End of new functionality
  ...
  Scenario: User has to reset their password intervention (happy path) (for auth user)
#  Scenario : User resets their password from the intervention ‘You need to reset your password’ screen
...
#End of new functionality
  ...
  Scenario : User is signed in to an RP via One Login, TICF put in place a reset password intervention, then the user accesses a different RP and is passed back to authentication
# Not yet done
