...
# ************************* Additional tests for IPV MFA journey **********************
  ...
  Scenario Outline: User is signing in via the one login v2 app
    ...
    Examples:
      ...
      | channel-mobile        | App      | I do not have access to the authenticator app | Open GOV.UK One Login in a web browser to continue |
      | channel-mobile        | SMS      | Problems with the code?                       | Open GOV.UK One Login in a web browser to continue |
