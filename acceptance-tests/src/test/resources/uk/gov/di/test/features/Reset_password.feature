...
#    Then the lockout screen for too many wrong security codes is displayed
...
#    Then the cannot sign in lockout screen for wrong security codes is displayed
#
#  @lockout
...
#    Then the lockout screen for requesting too many security code resends is displayed
...
#    Then the cannot sign in lockout screen for requesting too many security code resends is displayed
#
#  @lockout
